...
public final class Constants {
    ...
    public static final String TASK_PATH = "jsp/tasks/";

    public static final String KEY_USER_ATTR = "user";
    public static final String KEY_TASKS_ATTR = "tasks";
    ...
    public static final String ERROR_SOURCE = "Input source processing problems";
