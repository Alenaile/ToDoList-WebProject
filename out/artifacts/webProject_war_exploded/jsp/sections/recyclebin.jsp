...
<div class="intro">
    ...
    <div class="container">
        <form name="selectSection" action="<c:url value="/task"/>" method="get">
            <input type=hidden name="<%=Constants.SECTION_PARAMETER_NAME%>" value="no">

            <br/>
            <div class="section">
                <a class="nav_link" href="<c:url value="/main.jsp"/>">Active Tasks</a>&nbsp;&nbsp;
                <a class="nav_link" href="<c:url value="/jsp/sections/fixed.jsp"/>">Fixed Tasks</a>
            </div>
        </form>
                ...
                <div class="intro_inner tab">
                    <table name="recycle_bin">
                        ...
                        <c:forEach items="${tasks}" var="task">
                            <c:if test="${task.section == 'RECYCLEBIN'}">
                                <tr>
                                    <td>
                                        <input name="<%=Constants.CHECK_BOX_NAME %>" type="checkbox" value="${task.taskId}"/>
                                    </td>
