...
<div class="intro">
    <div class="container">
        ...
        <div>Return to <a class="nav_link" href="<c:url value='/welcome.jsp'/>">start page</a></div>
        <div>No account? <a class="nav_link" href="<c:url value='/registrate.jsp'/>">Registration</a></div>
