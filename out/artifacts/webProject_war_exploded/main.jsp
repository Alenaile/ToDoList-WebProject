...
<div class="intro">
    ...
    <div class="container">
        <form name="selectSection" action="<c:url value="main.jsp"/>" method="get">
            <input type=hidden name="<%=Constants.SECTION_PARAMETER_NAME%>" value="no">


            <div class="section">
                <a class="nav_link" href="jsp/sections/fixed.jsp">Fixed</a> &nbsp;&nbsp;
                <a class="nav_link" href="jsp/sections/recyclebin.jsp">Recycle Bin</a>
            </div>
        </form>
